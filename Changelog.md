...
Replace remote https://fonts.googleapis.com/css?.. by local `styles/lib/css/fonts.googleapis.css`.
Replace `4.7.0` by `6.0.0-beta2` font awesome version.
Replace remote https://cdnjs.cloudflare.com/ajax.. by local `styles/lib/css/all.min.css`.
Add `dl.sh` script.

Add `svg` font awesome. Fix big images width.
Fix missed `bar` and many other icons. TODO how it can be improved?
